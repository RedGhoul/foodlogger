  ...
  describe('CurrentWeight Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call User query and add missing value', () => {
        ...
        const user: IUser = { id: 64703 };
        currentWeight.user = user;

        const userCollection: IUser[] = [{ id: 34614 }];
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<CurrentWeight>>();
        const currentWeight = { id: 123 };
        jest.spyOn(currentWeightService, 'update').mockReturnValue(saveSubject);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        jest.spyOn(currentWeightService, 'create').mockReturnValue(saveSubject);
        jest.spyOn(comp, 'previousState');
        activatedRoute.data = of({ currentWeight });
        comp.ngOnInit();
