            ...
            .map(
                existingAppUser -> {
                    ...
                    if (appUser.getHeight() != null) {
                        existingAppUser.setHeight(appUser.getHeight());
                    }
                    if (appUser.getWorkoutsPerWeek() != null) {
                        existingAppUser.setWorkoutsPerWeek(appUser.getWorkoutsPerWeek());
                    }
                    if (appUser.getMinutesPerWorkout() != null) {
                        existingAppUser.setMinutesPerWorkout(appUser.getMinutesPerWorkout());
                    }
                    if (appUser.getDateOfBirth() != null) {
                        existingAppUser.setDateOfBirth(appUser.getDateOfBirth());
                    }
                    if (appUser.getActivityLevel() != null) {
                        existingAppUser.setActivityLevel(appUser.getActivityLevel());
                    }
